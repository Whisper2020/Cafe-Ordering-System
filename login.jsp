...
<script type="text/javascript" language="javascript">
    alert("user's name or password is wrong");                                            // 弹出错误信息
...
<form method="get" name="form" action="login1" >
<div class="wrap" id="wrap">
    <div class="logGet">
        ...
        <div class="logC">
            <a style="color: blue"><button onclick="check(this.form)">登 录</button></a>
        </div>

        <div class="logC">
            <p><input type="button"
                      value="注册"   onclick="userRegister()" ></a>
        </div>
        <div align="center">

                <input type="radio" name="identity" value=0 >管理员
                <input type="radio" name="identity" checked="checked" value=1>用户
...
<!--<form action="QueryUser" method="get">
    ...
    <div style="text-align: center;"><input type="submit" value="登录" onclick="return check(this.form)"></div>
    <div style="text-align: center;"><input type="button" value="注册" onclick="userRegister()"></div>
</form>-->
