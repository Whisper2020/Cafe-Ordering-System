...
<body>
		...
		<div>
			<ul id="nav">
				...
				<li><img align="left"
										...
										style="background-size: cover" /></img></li>
			</ul>
		</div>
	</div>
	...
	<div id="foodList">
		...
		<%
					...
					ResultSet rs;
					rs = stmt.executeQuery("SELECT * FROM food order by sales desc");										
					while (rs.next()) {
				%>
		...
		<div id="food1" class="horizontal" style="padding: 20px">
			<table class="pure-table">
				...
				<tbody>
					...
					<tr>
						<td id="path" background="<%=rs.getString("path")%>" height="205px" width="290px" style="background-size:cover"></td>
					</tr>
					<tr>
					...
					<tr>
						<td id="sales"><%="Sales: "+rs.getString("sales")%></td>
					</tr>
