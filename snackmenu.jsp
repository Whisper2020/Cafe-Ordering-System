...
<body>
	...
	<div>
		<div>
			<ul id="nav">
				<li><a href="operatorbreadmenu.jsp">Bread</a></li>
				<li><a href="operatorcakemenu.jsp">Cake</a></li>
				<li><a href="operatordrinkmenu.jsp">Drink</a></li>
				<li><a href="operatorsnackmenu.jsp">Snack</a></li>
			</ul>
		</div>
	</div>
...
<table class="pure-table">
	...
	<div id="foodList">
		...
		<%
					...
					ResultSet rs;
					rs = stmt.executeQuery("SELECT * FROM food where foodkind='snack'");										
					while (rs.next()) {
				%>
